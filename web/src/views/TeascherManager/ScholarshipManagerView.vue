          ...
          <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">奖学金金审核</h5>
...
export default {
  ...
  setup(){
    ...
    const refresh  = () => {
      $.ajax({
        url: "http://127.0.0.1:3000/studentmanager/scholarship/getall/",
        type: 'get',
        headers: {
    ...
    const getInfoById = (student_id) =>{
      ...
      $.ajax({
        url: "http://127.0.0.1:3000/studentmanager/student/getinfobyid/",
        type: 'get',
        data:{
    ...
    const kunnan_student_update = (kunnan_student) =>{
      $.ajax({
        url: "http://127.0.0.1:3000/studentmanager/scholarship/updateComment/",
        type: 'post',
        data:{
